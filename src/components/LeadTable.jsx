                ...
                <tr key={l.id} className="hover:bg-primary/5 transition-colors group">
                  ...
                  <td className="px-4 py-3.5">
                    <div className="tbl-seg mx-auto w-fit flex border border-slate-200 rounded-lg overflow-hidden">
                      ...
                      <button onClick={() => handleStatusClick(l.id, 'build_plus')} className={`px-2 py-1 text-[10px] font-bold uppercase transition-colors ${l.status === 'build_plus' ? 'bg-blue-100 text-blue-600' : 'text-slate-400 hover:bg-slate-50 border-r border-slate-200'}`}>Build+</button>
